...
public class OrderRepositoryAdapter {
  ...
  private final OrderRepositoryMongoRepository repository;

  public OrderRepositoryAdapter(OrderRepositoryMongoRepository repository) {
